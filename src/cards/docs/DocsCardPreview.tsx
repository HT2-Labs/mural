...
const DocsCardBasic = () => {
  return(
    <Card title="Card Title">
      <CardBody>
        <P>The new home for all shared components Defines whether the button is disabled or not
          Defines whether the button is disabled or not</P>
      </CardBody>
    ...
    >
      <CardBody>
        <H2
          ...
          alignment={Align.Center}
        >Shared components!</H2>
        <P size={SizeType.Medium} alignment={Align.Center}>Shared components!</P>
      </CardBody>
    </Card>
  );
}
